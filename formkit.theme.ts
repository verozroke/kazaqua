...
/**
  ...
  * @variables - radius=rounded,accentColor=blue,colorTemperature=neutral,spacing=2,scale=base,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-full,tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
