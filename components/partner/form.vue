<template>
  <div class="flex gap-5 min-h-96 ContactUs py-5 px-7 ">
    <div class="w-[50%]">
      <FormKit
        type="form"
        @submit="sendOrder"
    ...
    <div class="w-[50%] flex flex-col gap-6">
      ...
      <div class="text-base text-slate-600 max-w-96">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Pariatur,
